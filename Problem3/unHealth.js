...
d3.csv("unHealth.csv", function(data) { //source of data: http://unglobalpulse.net/ewec/
   ...
   //code block from Mike Bostock example: http://bl.ocks.org/mbostock/1667367#index.html
    ...
    var brush = d3.svg.brush()
        .x(xScaleOverview)
        .on("brush", console.log("brush!")); // replace console log with 'brushed'
    ...
    //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    //upper visualization for brushing -- modeled all of the below blocks on: http://bl.ocks.org/mbostock/1667367#index.html .
    ...
    var focus = svg.append("g")
        .attr("class", "focus")
        .attr("transform", "translate(" + bbOverview.x + "," + bbOverview.w + ")");

    var context = svg.append("g")
        .attr("class", "context")
        .attr("transform", "translate(" + bbDetail.x + "," + bbDetail.w + ")");
      ...
      context.append("g")
        ...
        .selectAll("rect")
          .attr("y", -6)
          .attr("height", bbDetail.h + 7);
      
    function brushed() {
      x.domain(brush.empty() ? xScaleOverview.domain() : brush.extent());
